...
CHAT_COMMAND("register", "?s[login] ?s[password]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConRegister, this, "Sign up on server")
CHAT_COMMAND("login", "?s[login] ?s[password]", CFGFLAG_CHAT | CFGFLAG_SERVER, ConLogin, this, "Log in on server")
CHAT_COMMAND("exit", "", CFGFLAG_CHAT | CFGFLAG_SERVER, ConLogoutAccount, this, "Log out on server")
